...
const listProjects = [
  ...
  },
  {
    ...
    feature: 'See Project',
    bgDivOne: "url('assets/images/work-img-18.png')",
    listPopupProjects: {
      popName: 'Budget App',
      popButton: '&times;',
      popDescription: 'The Budget app is about building a mobile web application where you can manage your budget: you have a list of expenses associated with a categorie, so that you can see how much money you spent and on what.',
